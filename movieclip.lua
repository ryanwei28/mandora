...
使用範例說明如下:
        ...
        建立movieclip
        explodeAnimation = movieClip.newAnim({"Explo1.png","Explo2.png","Explo3.png","Explo4.png","Explo5.png","Explo6.png","Explo7.png","Explo8.png","Explo9.png"})
        
        將movieclip停在某一個Frame
        explodeAnimation:stopAtFrame(9)

        播放movieclip
        explodeAnimation:play( {startFrame = 1 , endFrame = 9 , loop = 1 , remove = false})
